...
| Chabanne | +PSO+CAF(+P+CAF) | *net4.ipynb |
| CryptoDL | +PSO+CAF(+P+CAF) | *net5.ipynb |
| CryptoNN | +PSO+CAF(+P+CAF) | *net6.ipynb |
| Chabanne | +Taylor+CAF(+T+CAF) | *net7.ipynb |
| CryptoDL | +Taylor+CAF(+T+CAF) | *net8.ipynb |
| CryptoNN | +Taylor+CAF(+T+CAF) | *net9.ipynb |
