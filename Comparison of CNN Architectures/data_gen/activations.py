...
class SquareActivation(PolyActivation):
    ...
    def __init__(self):
        ...
        super(SquareActivation, self).__init__([0.1997, 0.5002, 0.1992])
        # super(SquareActivation, self).__init__([0.17, 0.5, 0.28])
        # super(SquareActivation, self).__init__([0.19, 0.5, 0.19])
        # super(SquareActivation, self).__init__([0.12, 0.5, 0.57])
